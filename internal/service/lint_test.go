...
func setupLintVault(t *testing.T) *vault.Vault {
	...
	for _, d := range []string{".obsidian", "meta", "project"} {
...
func TestLintService_Clippings(t *testing.T) {
	...
	files := map[string]string{
		...
		"research/security/good-url.md": "---\ntitle: Good URL\ntags:\n  - clipping\n  - research/security\ndate: 2026-05-10\n---\n\n## Sources\n\n- [Verbatim](https://wiki.example.com/raw/clippings/youtube/good.md)\n",
...
func TestLintService_Clippings_ConfigOverride(t *testing.T) {
	...
	defaultStylePage := "---\ntitle: Default Style\ntags:\n  - clipping\ndate: 2026-05-10\n---\n\n[Verbatim](https://wiki.example.com/raw/clippings/youtube/foo.md)\n"
	customStylePage := "---\ntitle: Custom Style\ntags:\n  - clip\ndate: 2026-05-10\n---\n\n[Verbatim](https://wiki.example.com/raw/sources/youtube/foo.md)\n"
